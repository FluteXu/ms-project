...
class RPNModule(torch.nn.Module):
    ...
    def _forward_train(self, anchors, objectness, rpn_box_regression, targets):
        if self.cfg.MODEL.RPN_ONLY:
            ...
            # print('feature map anchors: ', anchors)
            # print('feature map cls: ', objectness[0].shape)
            # print('feature map regression: ', rpn_box_regression[0].shape)
